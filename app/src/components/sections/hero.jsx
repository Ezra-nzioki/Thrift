...
export const Hero = () => {
  ...
  return (
    <>
      ...
      <div className='bg-(--secondary-color) border-2 border-(--text-color) rounded-lg w-[100%] mx-auto -mt-2 relative z-20 p-4 md:p-6 grid grid-cols-2 md:grid-cols-4 gap-0 items-center'>
